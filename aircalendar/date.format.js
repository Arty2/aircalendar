 ...
 * Modified by Heracles Papatheodorou <heracl.es> on 2019-02-17 to enable Greek translations
 * MIT license
 *
	...
	return function (date, mask, utc, lang) {
		...
		var	_ = utc ? "getUTC" : "get",
			...
			flags = {
				d:    d,
				dd:   pad(d),
				ddd:  dF.i18n[lang].dayNames[D],
				dddd: dF.i18n[lang].dayNames[D + 7],
				m:    m + 1,
				mm:   pad(m + 1),
				mmm:  dF.i18n[lang].monthNames[m],
				mmmm: dF.i18n[lang].monthNames[m + 12],
				yy:   String(y).slice(2),
				yyyy: y,
				h:    H % 12 || 12,
				hh:   pad(H % 12 || 12),
...
dateFormat.i18n['el'] = {
	...
	monthNames: [
		'Ιαν', 'Φεβ', 'Μάρ', 'Απρ', 'Μαι', 'Ιουν', 'Ιουλ', 'Αυγ', 'Σεπ', 'Οκτ', 'Νοε', 'Δεκ',
